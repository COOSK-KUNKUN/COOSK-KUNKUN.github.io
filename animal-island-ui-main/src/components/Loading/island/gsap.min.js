...
(function (e) {
    ...
    function Aa(t, e, r, i) {
        return (
            qt(t, e),
            t._initted
                ? !r && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && d !== Ot.frame
    ...
    function Sa(u, t) {
        ...
        return (
            !e &&
                r(u) &&
                ((h = e = u.radius || R),
                u.values ? ((u = yt(u.values)), (l = !p(u[0])) && (h *= h)) : (u = Ra(u.increment))),
            Ha(
                t,
                e
                    ? o(u)
    ...
    var Rt,
        ...
        Et =
            ...
            (Rt.totalDuration = function totalDuration(t) {
                return arguments.length
                    ? ((this._dirty = 0),
                      Da(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
                    : this._tDur;
            }),
            (Rt.totalTime = function totalTime(t, e) {
                ...
                return (
                    (this._tTime !== t || (!this._dur && !e) || (this._initted && Math.abs(this._zTime) === B)) &&
                    ...
                    (this._onUpdate && !e && bt(this, 'onUpdate', !0),
                        ((v === m && m >= this.totalDuration()) || (!v && this._ts < 0)) &&
                            ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                                this._lock ||
                                ((!t && g) || !((t && 0 < this._ts) || (!v && this._ts < 0)) || qa(this, 1),
                                e ||
                                    (t < 0 && !_) ||
                ...
                return arguments.length
                    ? ((this._forcing = 1),
                      this.parent ||
                          ...
                          !this._ts ||
                          (this._start = aa(
                              Ot.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts)
                          )),
        ...
        It = function _addPropTween(t, e, r, i, a, s, u, h, l) {
            ...
            if (
                (n(i) &&
                    ...
                    '=' === i.charAt(1) &&
                        (i = parseFloat(c) + parseFloat(i.substr(2)) * ('-' === i.charAt(0) ? -1 : 1) + (Ja(c) || 0))),
                c !== i)
            )
                return isNaN(c + i)
                    ? (d || e in t || L(e, i),
                    ...
                    : ((f = new ee(this._pt, t, e, +c || 0, i - (c || 0), 'boolean' == typeof d ? Ht : Jt, 0, p)),
                      l && (f.fp = l),
                    ...
                    if (
                        ...
                        for (n in r)
                            ht[n] && (f = Jb(n, r, t, c, o, z))
                                ? f.priority && (u = 1)
                                : (d[n] = a = It.call(t, o, n, 'get', r[n], c, z, 0, _.stringFilter));
        ...
        Ut = (function (A) {
            function Tween(t, e, i, n) {
                ...
                if (
                    ((a._targets = P.length
                        ? Y(P)
                        : M('GSAP target ' + t + ' not found. https://greensock.com', !G.nullTargetWarn) || []),
                    (a._ptLookup = []),
                    (a._overwrite = w),
                    x || b || u(v) || u(y))
                ) {
            ...
            return (
                            ...
                            if (((i = _), (l = this.timeline), this._repeat)) {
                                ...
                                a !== o &&
                                    (!this.vars.repeatRefresh ||
                                        u ||
                                        this._lock ||
                                        ((this._lock = r = 1), (this.render(s * a, !0).invalidate()._lock = 0)));
                            }
                            if (!this._initted) {
                ...
                (t.kill = function kill(t, e) {
                    ...
                    for (
                        ...
                        if (~f.indexOf(l[h]))
                            for (o in ((i = d[h]),
                            'all' === e ? ((r[h] = e), (s = i), (a = {})) : ((a = r[h] = r[h] || {}), (s = e)),
                            s))
                                ((u = i && i[o]) &&
                                    (('kill' in u.d && !0 !== u.d.kill(o)) || pa(this, u, '_pt'), delete i[o]),
                                    'all' !== a && (a[o] = 1));
    ...
    var re = {
        ...
        exportRoot: function exportRoot(t, e) {
            ...
            for (
                ...
                ((i = r._next),
                    (!e && !r._dur && r instanceof Ut && r.vars.onComplete === r._targets[0]) ||
                        ...
                        for (r in e)
                            for (i = a.length; i--; )
                                (n = (n = t._ptLookup[i][r]) && n.d) &&
                                    (n._pt && (n = ec(n, r)), n && n.modifier && n.modifier(e[r], t, a[i], r));
                    })(t, i);
                };
            },
        };
    ...
    function ld(e) {
        ...
        return (
            ...
            !r || r.width || r.x || r.y
                ? r
                : { x: +kd(e, ['x', 'cx', 'x1']) || 0, y: +kd(e, ['y', 'cy', 'y1']) || 0, width: 0, height: 0 }
        );
    }
    function md(t) {
        ...
        return (
            ...
            Se[e] && 'transform' !== e
                ...
                : ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) ||
                  (n = (Xe[e] && Xe[e](t, e, r)) || fd(t, e) || $(t, e) || ('opacity' === e ? 1 : 0)),
    ...
    function sd(t, e, r, i) {
        ...
        if (
            ...
            (v.e = i),
            (r += ''),
            'auto' === (i += '') && ((t.style[e] = i), (i = fd(t, e) || i), (t.style[e] = r)),
            ob((s = [r, i])),
            (i = s[1]),
            (u = (r = s[0]).match(tt) || []),
            (i.match(tt) || []).length)
    ...
    var ne,
        ...
        Ze = function _parseTransform(t, e) {
            ...
            return (
                ...
                (r.y =
                    ((r.yPercent = n && Math.round(t.offsetHeight / 2) === Math.round(-n) ? -50 : 0) ? 0 : n) + 'px'),
                (r.z = a + 'px'),
                (r.scaleX = aa(s)),
                (r.scaleY = aa(o)),
                (r.rotation = aa(u) + L),
                    ...
                    if ('autoRound' !== f && ((s = e[f]), !ht[f] || !Jb(f, e, r, i, t, n)))
                        if (
                            ...
                            if (
                                ...
                                f in Le &&
                                    ('autoAlpha' === f &&
                                        (1 === u && 'hidden' === rd(t, 'visibility') && o && (u = 0),
                                        od(
                                            this,
                                            b,
                                            'visibility',
                                ...
                                if (
                                    (m ||
                                        ...
                                        ((m = this._pt =
                                            new ee(this._pt, b, Ie, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)),
                                    'scale' === f)
                                )
...
export const gsap = __e__.gsap;
export default __e__.default;
