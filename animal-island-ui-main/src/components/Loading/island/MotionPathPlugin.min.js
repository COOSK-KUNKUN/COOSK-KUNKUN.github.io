...
(function (t) {
    ...
    function measureSegment(t, e, n) {
        ...
        if (R.length && N)
            for (t.totalLength = y = R[R.length - 1] || 0, t.minLength = N, x = v = 0, r = 0; r < y; r += N)
                S[x++] = R[v] < r ? ++v : v;
    ...
    function subdivideSegment(t, e, n) {
        ...
        return (
            (u += (d - u) * n),
            (f += (m - f) * n),
            t.splice(e + 2, 4, C(h), C(g), C(p), C(c), C(p + (u - p) * n), C(c + (f - c) * n), C(u), C(f), C(d), C(m)),
    ...
    function getPositionOnPath(t, e, n, r) {
        ...
        return (
            ...
            (g = p[(h = 6 * ~~(h / o))]),
            (c.x = C((u * u * (p[h + 6] - g) + 3 * f * (u * (p[h + 4] - g) + f * (p[h + 2] - g))) * u + g)),
            (c.y = C(
                (u * u * (p[h + 7] - (g = p[h + 1])) + 3 * f * (u * (p[h + 5] - g) + f * (p[h + 3] - g))) * u + g
            )),
            n && (c.angle = p.totalLength ? getRotationAtBezierT(p, h, 1 <= u ? 1 - 1e-9 : u || 1e-9) : p.angle || 0),
            c
        );
    }
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < P; e++)
            if (
                ...
                ((u = x),
                    (g = y),
                    ('C' !== p && 'S' !== p) || ((u += x - s[s.length - 4]), (g += y - s[s.length - 3])),
                    i || (x = y = 0),
                ...
                ('Z' === o && ((r = l), (a = h), (s.closed = !0)),
                    ('L' === o || 0.5 < H(x - r) || 0.5 < H(y - a)) && (qf(x, y, r, a), 'L' === o && (e += 2)),
                    (x = r),
                    (y = a));
            else if ('A' === o) {
                if (
    ...
    function pointsToSegment(t, e, n) {
        ...
        for (
            isNaN(n) && (n = Math.PI / 10),
                T && (t.push(P, w), (P = x), (w = y), (x = t[v - 2]), (y = t[v - 1]), t.unshift(x, y), (v += 4)),
                e = e || 0 === e ? +e : 1,
                s = 2;
            s < v;
            s += 2
            ...
            ((r = x),
                ...
                (x === r && y === a) ||
                    (n < o
                        ? ((i = S(g, h)),
                          b.push(C(x - U(i) * f), C(y - W(i) * f), C(x), C(y), C(x + U(i) * p), C(y + W(i) * p)))
                        : ((i = S(u, l)),
    ...
    function na(t, e, n, r) {
        ...
        return (
            ...
            'auto' === r &&
                ...
                ((a = e.getAttribute('d').match(K) || []), (h += (a = i.apply({ x: +a[0], y: +a[1] })).x), (u += a.y)),
            (a || (e.getBBox && t.getBBox)) && ((h -= (a = i.apply(e.getBBox())).x), (u -= a.y)),
            (i.e = h - s.x),
            (i.f = u - s.y),
            i
        );
                ...
                ? (i &&
                      ('self' === i || (r = Q(i)[0] || e) === e
                          ...
                          : (u && !1 !== u[2]
                            ...
                            transformRawPath(t, a.a, a.b, a.c, a.d, p + a.e - (o.x - a.e), c + a.f - (o.y - a.f)))),
                  s
        ...
        a = {
            ...
            init: function init(t, e) {
                ...
                if (
                    ...
                    for (r in (a && o
                        ? i.push(ja(this, ga(ga([], s, a, 0), s, o, 1), t, e.x || a, e.y || o, u, e))
                        : (a = o = 0),
                    l))
...
export const MotionPathPlugin = __e__.MotionPathPlugin;
